...
{
    double pt_homogeneous[3][1] = {{pt0[0]}, {pt0[1]}, {1.0}};
    cv::Mat l = F * cv::Mat(3, 1, CV_64F, pt_homogeneous);
    double lenght = (pt1[0] * l.at<double>(0,0) + pt1[1] * l.at<double>(0,1) + l.at<double>(0,2)) /
